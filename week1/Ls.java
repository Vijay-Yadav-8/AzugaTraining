...
public class Ls {
   private static final Logger logger = LogManager.getLogger(Ls.class);
    ...
    public static void help() {
		logger.info("help method is invoked");
