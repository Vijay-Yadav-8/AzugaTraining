...
public class Converter implements Convert {
    ...
    private static final String srcPath ="/Users/azuga/Desktop/museum1.csv";
    /**
     * This method converts the csv file to html format
     */
    public void csvToHtml() {
        long start = System.currentTimeMillis();
        String destPath ="/Users/azuga/Desktop/museum3.html";
        List<String> lines = new ArrayList<>();
        logger.info("reading data from {} using buffered reader",srcPath);
        try (BufferedReader reader = new BufferedReader(new FileReader(srcPath))) {//reading the file here
            String currentLine;
        ...
        logger.info("writing the html data to specified destination path i.e,{}",destPath);
        try (FileWriter writer = new FileWriter(destPath)) {//writing String to html file
    ...
    public void csvToPdf() throws IOException {
        long start = System.currentTimeMillis();
        String destPath = "/Users/azuga/Desktop/museum2.pdf";
        CSVReader reader = null;
        logger.info("reading data from specified path i.e, {}",srcPath);
        try {
            reader = new CSVReader(new FileReader(srcPath));//reading csv file from given path
        ...
        logger.info("writing the pdf data to specified destination path i.e,{}",destPath);
        try {
            PdfWriter.getInstance(my_pdf_data, new FileOutputStream(destPath));//writing pdf file to given path
        } catch (DocumentException | FileNotFoundException e) {
            logger.error("{} occurred while writing file to {}",e,srcPath);
        }
        my_pdf_data.open();
    ...
    public void jsonToXml(){
        long start = System.currentTimeMillis();
        String src = "/Users/azuga/Desktop/museum.json";
        String dest ="/Users/azuga/Desktop/museum4.xml";
        ...
        try {
            ...
            System.out.println("Your XML data is successfully written into"+dest);
            // close FileWriter
            file.close();
    ...
    public void csvToExcel() {
        ...
        try(FileWriter fw = new FileWriter("/Users/azuga/Desktop/museum123.xlsx")){
            ...
            logger.info("writing the pdf data to specified destination path i.e,{}","/Users/azuga/Desktop/museum123.xlsx");
            fw.write(Files.readString(Path.of("/Users/azuga/Desktop/museum1.csv")));
            System.out.println("file is saved as museum123.xlsx");
        }catch (Exception e) {
            logger.error("{} occurred while writing file to {} or reading file from {}",e,"/Users/azuga/Desktop/museum123.xlsx",srcPath);
        }
